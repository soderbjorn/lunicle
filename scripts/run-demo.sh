...
# app's own default (LUNICLE_DEFAULT_* in ThemePersister.kt): Lunamux Classic Dark,
# with Classic Light in the other slot — the same as an unbranded real instance.
#
