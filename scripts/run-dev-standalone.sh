...
#
#   ./scripts/run-dev-standalone.sh              → http://localhost:8080/
#   ./scripts/run-dev-standalone.sh --no-open    # don't launch a browser
#
...
# For the tracker inside the lunamux site:  ./scripts/run-dev-embedded.sh
#
...
cat <<EOF
    ...
    ─────────────────────────────────────────────────────────────
      ...
      For the embed:  ./scripts/run-dev-embedded.sh
    ─────────────────────────────────────────────────────────────
